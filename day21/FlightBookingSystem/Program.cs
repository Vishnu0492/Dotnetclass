...
namespace FlightBookingSystem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DomesticFlight domesticFlight = new DomesticFlight("EF123", "New Delhi", "India", 150);
            ...
            Passenger passenger1 = new Passenger(1, "Vishnu Priya");
            ...
            DomesticFlight domesticFlight1 = new DomesticFlight("DF123", "New delhi", "India", 150);
            DomesticFlight domesticFlight2 = new DomesticFlight("DF456", "Kolkata", "India", 120);
        ...
        {
            new DomesticFlight("DF123", "New Delhi", "India", 150),
            new DomesticFlight("DF456", "Kolkata", "India", 120),
